...
namespace MedCore.Persistence.Interfaces.appointments
{
    public interface IDoctorAvailabilityRepository : IBaseReporsitory<DoctorAvailability, int>
    {
        ...
        Task<OperationResult> IsDoctorAvailableAsync(int doctorId, DateTime appointmentDate, TimeSpan startTime, TimeSpan endTime); //Verificar si un doctor está disponible en una fecha y hora específica
